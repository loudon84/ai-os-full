...
const meta: Meta = {
  title: "Pages/Utility/ComingSoon",
  tags: ["autodocs"],
  parameters: {
    layout: "fullscreen",
    docs: {
  ...
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border">
        <h2 className="text-xl font-semibold mb-2">ComingSoonPage</h2>
...
export const Empty: Story = {
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border">
        <h2 className="text-xl font-semibold mb-2">ComingSoonPage - Empty</h2>
...
export const Loading: Story = {
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border">
        <h2 className="text-xl font-semibold mb-2">ComingSoonPage - Loading</h2>
  ...
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border border-destructive">
        <h2 className="text-xl font-semibold mb-2 text-destructive">ComingSoonPage - Error</h2>
