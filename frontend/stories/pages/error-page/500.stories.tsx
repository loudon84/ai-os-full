  ...
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border">
        <h2 className="text-xl font-semibold mb-2">Error500Page</h2>
...
export const Empty: Story = {
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border">
        <h2 className="text-xl font-semibold mb-2">Error500Page - Empty</h2>
...
export const Loading: Story = {
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border">
        <h2 className="text-xl font-semibold mb-2">Error500Page - Loading</h2>
  ...
  render: () => (
    <div className="flex items-center justify-center h-screen bg-default-50">
      <div className="text-center p-8 bg-background rounded-lg shadow-lg border border-destructive">
        <h2 className="text-xl font-semibold mb-2 text-destructive">Error500Page - Error</h2>
